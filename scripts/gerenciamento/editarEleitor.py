    ...
    if resultado:
        ...
        match opcao:
            case 1:
                    ...
                    sql = "UPDATE eleitores SET nome = %s, chave_de_acesso = %s WHERE id_eleitores = %s"
                    cursor.execute(sql, (nome, chave_de_acesso, resultado['id_eleitores']))
                    conexao.commit()
                    cursor.close()
                    conexao.close()
                    #mensagem final 
            ...
            case 2:
                    ...
                    if cursor.fetchone():
                        ...
                        editar()
                        return
                    sql = "UPDATE eleitores SET cpf = %s WHERE id_eleitores = %s"
                    cursor.execute(sql, (criptografia_cpf, resultado['id_eleitores']))
                    conexao.commit()
                    cursor.close()
                    conexao.close()
                    #mensagem final 
            ...
            case 3:
                    ...
                    if not validacao_titulo.validacaoTitulo(titulo_eleitor):
                        ...
                        editar()
                        return
                    sql = "UPDATE eleitores SET titulo_de_eleitor = %s WHERE id_eleitores = %s"
                    cursor.execute(sql, (criptografia_TE, resultado['id_eleitores']))
                    conexao.commit()
                    cursor.close()
                    conexao.close()
                    #mensagem final 
            ...
            case 4:
                    ...
                    if mesario == 'SIM':
                        ...
                        editar()
                        return
                    sql = "UPDATE eleitores SET mesario = %s WHERE id_eleitores = %s"
                    cursor.execute(sql, (mesario, resultado['id_eleitores']))
                    conexao.commit()
                    cursor.close()
                    conexao.close()
                    #mensagem final 
            ...
            case 5:
                    ...
                    chave_de_acesso = partes_nome[0][:2].upper() + partes_nome[1][0].upper() + str(random.randint(1000, 9999))
                    #insert no BD
                    sql = "UPDATE eleitores SET nome = %s, cpf = %s, titulo_de_eleitor = %s, mesario = %s, chave_de_acesso = %s WHERE id_eleitores = %s"
                    cursor.execute(sql, (nome, criptografia_cpf, criptografia_TE, mesario, chave_de_acesso, resultado['id_eleitores']))
                    conexao.commit()
                    cursor.close()
                    conexao.close()
                    #mensagem final 
