...
if len(titulo) != 12:
    print('Título inváludo: deve conter exatamente 12 digitos.')
else: 
...
if titulo_valido == False:
    print('Título inválido: deve conter apenas números.')
else: 
...
if unidade_federativa < 1 or unidade_federativa > 28:
    print('Título inválido: código de UF inválido.')
else:
...
if primeiro_digito_verificador_calculado == int(primeiro_digito_verificador_informado) and segundo_digito_verificador_calculado == int(segundo_digito_verificador_informado):
    ...
    print('Título de eleitor inválido: Dígitos Verificadores incorretos')
